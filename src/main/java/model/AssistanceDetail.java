 ...
 */
@Schema(description = "Retrieves the assistance detail information")
...
public class AssistanceDetail {
  ...
  public AssistanceDetail id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "01", description = "Indicates the assistance identifier.")
  public String getId() {
    return id;
  }
  ...
  public AssistanceDetail status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @Schema(description = "Indicates the status of the assistance.   * `ACTIVE` -  Indicates that status for recurrent payment is active in this moment.   * `INACTIVE` - Indicates that the recurrent payment status is deactivated. ")
  ...
  public AssistanceDetail operationDate(OffsetDateTime operationDate) {
