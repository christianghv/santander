 ...
 */
@Schema(description = "Credit limit granted by the financial institution.")
...
public class AllOfCreditBalancesCreditLimit extends Money {
  ...
  public String toString() {
    ...
    sb.append("class AllOfCreditBalancesCreditLimit {\n");
