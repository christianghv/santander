...
public class CreditDetail extends Credit {
  @SerializedName("related_cards")
  private List<Card> relatedCards = new ArrayList<Card>();

  @SerializedName("available_products")
  private List<Object> availableProducts = new ArrayList<Object>();

  @SerializedName("balances")
  private Object balances = null;

  public CreditDetail relatedCards(List<Card> relatedCards) {
    this.relatedCards = relatedCards;
    return this;
  }

  public CreditDetail addRelatedCardsItem(Card relatedCardsItem) {
   ...
   * @return relatedCards
  **/
  @Schema(required = true, description = "Card associated with the credit line.")
  ...
  public CreditDetail availableProducts(List<Object> availableProducts) {
    this.availableProducts = availableProducts;
    return this;
  }

  public CreditDetail addAvailableProductsItem(Object availableProductsItem) {
  ...
  **/
  @Schema(required = true, description = "EXPAND: Credit products associated with the credit line. (This information its ONLY RETRIEVED if the expand parameter contains *available_products*)")
  ...
  public CreditDetail balances(Object balances) {
   ...
   * @return balances
  **/
  @Schema(required = true, description = "EXPAND: The available balances of a credit line. (This information its ONLY RETRIEVED if the expand parameter contains *balances*)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditDetail creditDetail = (CreditDetail) o;
    return Objects.equals(this.relatedCards, creditDetail.relatedCards) &&
        Objects.equals(this.availableProducts, creditDetail.availableProducts) &&
        Objects.equals(this.balances, creditDetail.balances) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(relatedCards, availableProducts, balances, super.hashCode());
  }
