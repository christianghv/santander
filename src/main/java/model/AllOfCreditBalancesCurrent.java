 ...
 */
@Schema(description = "Indicates the current balance of the credit line.")
...
public class AllOfCreditBalancesCurrent extends Money {
  ...
  public String toString() {
    ...
    sb.append("class AllOfCreditBalancesCurrent {\n");
