 ...
 */
@Schema(description = "Authorized money withheld from credit card for transactions in transit.")
...
public class AllOfCreditBalancesPending extends Money {
  ...
  public String toString() {
    ...
    sb.append("class AllOfCreditBalancesPending {\n");
